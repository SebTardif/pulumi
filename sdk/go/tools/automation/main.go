...
// can initialise them via composite literals.
...
// definition in sdk/go/auto/automation/base/base.go; the generator's
// output for the BaseOptions surface is structurally identical to the
// embedded form, just expanded so composite-literal initialisation works.
