...
func (p *UnimplementedProvider) List(context.Context, ListRequest) (ListResponse, error) {
	return ListResponse{}, status.Error(codes.Unimplemented, "List is not yet implemented")
}
