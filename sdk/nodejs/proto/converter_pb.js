...
goog.exportSymbol('proto.pulumirpc.GenerateSnippetRequest', null, global);
goog.exportSymbol('proto.pulumirpc.GenerateSnippetResponse', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.GenerateSnippetRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.GenerateSnippetRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.GenerateSnippetRequest.displayName = 'proto.pulumirpc.GenerateSnippetRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pulumirpc.GenerateSnippetResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pulumirpc.GenerateSnippetResponse.repeatedFields_, null);
};
goog.inherits(proto.pulumirpc.GenerateSnippetResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.GenerateSnippetResponse.displayName = 'proto.pulumirpc.GenerateSnippetResponse';
}
 ...
 * @return {!Object}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.GenerateSnippetRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.GenerateSnippetRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateSnippetRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.GenerateSnippetRequest}
 */
proto.pulumirpc.GenerateSnippetRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.GenerateSnippetRequest;
  return proto.pulumirpc.GenerateSnippetRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.GenerateSnippetRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.GenerateSnippetRequest}
 */
proto.pulumirpc.GenerateSnippetRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.GenerateSnippetRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.GenerateSnippetRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateSnippetRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getFilename = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.GenerateSnippetRequest} returns this
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.setFilename = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getSource = function() {
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getSource_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getSource_asU8 = function() {
 ...
 * @return {!proto.pulumirpc.GenerateSnippetRequest} returns this
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.setSource = function(value) {
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getTargetLoader = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.pulumirpc.GenerateSnippetRequest} returns this
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.setTargetLoader = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.pulumirpc.GenerateSnippetRequest} returns this
 */
proto.pulumirpc.GenerateSnippetRequest.prototype.setToken = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @const
 */
proto.pulumirpc.GenerateSnippetResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.GenerateSnippetResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.GenerateSnippetResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateSnippetResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
diagnosticsList: jspb.Message.toObjectList(msg.getDiagnosticsList(),
    pulumi_codegen_hcl_pb.Diagnostic.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.GenerateSnippetResponse}
 */
proto.pulumirpc.GenerateSnippetResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.GenerateSnippetResponse;
  return proto.pulumirpc.GenerateSnippetResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.GenerateSnippetResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.GenerateSnippetResponse}
 */
proto.pulumirpc.GenerateSnippetResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.GenerateSnippetResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.GenerateSnippetResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateSnippetResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDiagnosticsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.pulumirpc.codegen.Diagnostic>}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.getDiagnosticsList = function() {
  return /** @type{!Array<!proto.pulumirpc.codegen.Diagnostic>} */ (
    jspb.Message.getRepeatedWrapperField(this, pulumi_codegen_hcl_pb.Diagnostic, 1));
};
...
/**
 * @param {!Array<!proto.pulumirpc.codegen.Diagnostic>} value
 * @return {!proto.pulumirpc.GenerateSnippetResponse} returns this
*/
proto.pulumirpc.GenerateSnippetResponse.prototype.setDiagnosticsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.pulumirpc.codegen.Diagnostic}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.addDiagnostics = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pulumirpc.codegen.Diagnostic, opt_index);
};
 ...
 * @return {!proto.pulumirpc.GenerateSnippetResponse} returns this
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.clearDiagnosticsList = function() {
  return this.setDiagnosticsList([]);
};
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.getFilename = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.GenerateSnippetResponse} returns this
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.setFilename = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.getSource = function() {
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.getSource_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getSource()));
};
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.getSource_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getSource()));
};
 ...
 * @return {!proto.pulumirpc.GenerateSnippetResponse} returns this
 */
proto.pulumirpc.GenerateSnippetResponse.prototype.setSource = function(value) {
